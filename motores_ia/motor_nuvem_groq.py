...
def configurar_motor_nuvem():
    ...
    system_prompt = (
        ...
        "Whenever you cite or describe a specific project by name, include that project's links from the materials in the same answer "
        "(repository, deploy/demo, or other URLs exactly as written there). If no public URL exists in the materials for that project, "
        "state that briefly—do not skip links when they exist in the context.\n"
