...
def configurar_motor_nuvem():
    ...
    system_prompt = (
        ...
        "For Chatbot Nascentia / TCC Nascentia: it is a group project—whenever you mention it, credit all teammates named in the materials "
        "(not only Mateus), e.g. list the integrants from the Nascentia section.\n"
        "</status_rule>\n\n"
        "<reference_date>\n"
