...
def configurar_motor_nuvem():
    ...
    system_prompt = (
        ...
        "For Chatbot Nascentia: it was a three-semester group Integrador project at CEUB (graduation capstone equivalent, not formally a TCC)—describe it that way. "
        "Whenever you mention it, credit all teammates named in the materials (not only Mateus).\n"
        "</status_rule>\n\n"
        "<reference_date>\n"
