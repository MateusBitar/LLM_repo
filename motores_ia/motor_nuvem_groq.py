...
def configurar_motor_nuvem():
    ...
    system_prompt = (
        ...
        "Never invent employers, grades, facts, or URLs. Use links exactly as they appear in the context.\n\n"
        "<projects_rule>\n"
        ...
        "</projects_rule>\n\n"
        "<status_rule>\n"
        "If the context says a project is in development, WIP, or not yet in production, state that clearly when asked about production status. "
